...
//t-table addresses
#define te0 0x7f87973f90a0
#define te1 0x7f87973f94a0
#define te2 0x7f87973f98a0
#define te3 0x7f87973f9ca0
...
void flushAttack(int sockfd)
{
    ...
    plaintext = malloc(sizeof(unsigned int) * 16);
    ciphertext = malloc(sizeof(unsigned int) * 16);
